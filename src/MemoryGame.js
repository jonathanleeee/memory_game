...
//            the card should never move from MATCHING to another state during game
const CardState = {
  HIDING: 0,
  SHOWING: 1,
  MATCHING: 2
...
class MemoryGame extends Component {
  ...
  // The cars that we will use for our state.
  let cards = [
  ...
  handleClick(id) {
    ...
    // takes in an array of cards, an array of IDs to change, what state those IDs should have.
    ...
    // grab the card we want out of the array
